...
\newcommand{\NaslovRada}{Kartezijanski zatvorene kategorije}
\newcommand{\ImePrezimeMentora}{prof. dr. sc. Boris Širola \\
izv. prof. dr. sc. Mladen Vukovi\'c 
}
% Pocetak dokumenta
%
\begin{document}
...
\bibitem{Harold Simmons}
\textit{An Introduction to Category theory}

\bibitem{Michael Barr} Charles Wells
